...
#include "../../../../src/core/man/gateway.h"
...
static constexpr auto qt_meta_stringdata_ZN7GateWayE = QtMocHelpers::stringData(
    "GateWay"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7GateWayE[] = {
...
Q_CONSTINIT const QMetaObject GateWay::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7GateWayE.offsetsAndSizes,
    qt_meta_data_ZN7GateWayE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7GateWayE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<GateWay, std::true_type>
    >,
    nullptr
} };
...
void *GateWay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7GateWayE.stringdata0))
