...
#include "../../../../src/core/middle/model/datamodel.h"
...
void DataModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->frameUpdated((*reinterpret_cast< std::add_pointer_t<QVariantMap>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (DataModel::*)(const QString & , const QVariant & );
            if (_q_method_type _q_method = &DataModel::valueChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (DataModel::*)(const QVariantMap & );
            if (_q_method_type _q_method = &DataModel::frameUpdated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void DataModel::valueChanged(const QString & _t1, const QVariant & _t2)
{
...
// SIGNAL 1
void DataModel::frameUpdated(const QVariantMap & _t1)
{
