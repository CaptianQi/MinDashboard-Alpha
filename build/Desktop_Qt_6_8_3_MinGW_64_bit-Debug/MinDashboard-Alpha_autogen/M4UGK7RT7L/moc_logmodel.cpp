...
#include "../../../../src/ui/uimain/logmodel.h"
...
static constexpr auto qt_meta_stringdata_ZN8LogModelE = QtMocHelpers::stringData(
    "LogModel",
    "appendLog",
    "",
    "Logger::Level",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8LogModelE[] = {
...
Q_CONSTINIT const QMetaObject LogModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8LogModelE.offsetsAndSizes,
    qt_meta_data_ZN8LogModelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8LogModelE_t,
        // Q_OBJECT / Q_GADGET
...
void LogModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->appendLog((*reinterpret_cast< std::add_pointer_t<Logger::Level>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QDateTime>>(_a[3]))); break;
        case 1: _t->clear(); break;
        case 2: _t->saveToFile((*reinterpret_cast< std::add_pointer_t<QUrl>>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *LogModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8LogModelE.stringdata0))
